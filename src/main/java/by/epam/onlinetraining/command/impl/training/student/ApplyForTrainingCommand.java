...
public class ApplyForTrainingCommand implements Command {
    ...
    private static final String SHOW_TRAININGS_COMMAND = "controller?command=showTrainings";//TODO
    ...
    public CommandResult execute(HttpServletRequest request, HttpServletResponse response) throws ServiceException {
        ...
        return CommandResult.redirect(SHOW_TRAININGS_COMMAND + PAGE_NUMBER_PARAMETER + pageNumber
                + LIMIT_PARAMETER + limit);//TODO
    }
}
