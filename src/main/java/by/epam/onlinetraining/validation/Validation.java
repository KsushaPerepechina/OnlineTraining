...
public class Validation {
    ...
    private static final String TRAINING_NAME_PATTERN = "^[A-z0-9:&+#.,\u0020]{2,50}$";
    ...
    private static final String PROGRESS_PATTERN = "^(REGISTRATION_OPENED|IN_PROCESS|FINISHED)$";
    private static final String STATUS_PATTERN = "^(REQUESTED|APPROVED|REJECTED|IN_PROCESS|EXPELLED|COMPLETED)$";
