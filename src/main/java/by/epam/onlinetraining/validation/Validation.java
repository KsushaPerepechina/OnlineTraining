...
public class Validation {
    ...
    private static final String BIRTH_DATE = "birthDate";//TODO
    ...
    private static final String START_DATE = "startDate";//TODO валидация на промежток
    private static final String END_DATE = "endDate";//TODO валидация на промежток
    private static final String TRAINING_PROGRESS = "progress";
    private static final String ASSIGNMENT_TYPE = "type";
    ...
    private static final String DATE_PATTERN = "^(((0[13-9]|1[012])[-]?(0[1-9]|[12][0-9]|30)|(0[13578]|1[02])[-]?31|02[-]?(0[1-9]|1[0-9]|2[0-8]))[-]?[0-9]{4}|02[-]?29[-]?([0-9]{2}(([2468][048]|[02468][48])|[13579][26])|([13579][26]|[02468][048]|0[0-9]|1[0-6])00))|(((0[13-9]|1[012])[-]?(0[1-9]|[12][0-9]|30)|(0[13578]|1[02])[-]?31|02[-]?(0[1-9]|1[0-9]|2[0-8]))[-]?[0-9]{4}|02[-]?29[-]?([0-9]{2}(([2468][048]|[02468][48])|[13579][26])|([13579][26]|[02468][048]|0[0-9]|1[0-6])00))$";
    ...
    private static final String TRAINING_PROGRESS_PATTERN = "^(REGISTRATION_OPENED|IN_PROCESS|FINISHED)$";
    private static final String STUDENT_STATUS_PATTERN = "^(REQUESTED|APPROVED|REJECTED|IN_PROCESS|EXPELLED|COMPLETED)$";
    private static final String ASSIGNMENT_TYPE_PATTERN = "^(TASK|TOPIC)$";
    ...
    private String definePattern(String parameter) {
        switch (parameter) {
            ...
            case TRAINING_PROGRESS:
                return TRAINING_PROGRESS_PATTERN;
            case STUDENT_STATUS:
                return STUDENT_STATUS_PATTERN;
            case ASSIGNMENT_TYPE:
                return ASSIGNMENT_TYPE_PATTERN;
            case MARK:
            case PERFORMANCE:
            case QUALITY:
                return MARK_PATTERN;
