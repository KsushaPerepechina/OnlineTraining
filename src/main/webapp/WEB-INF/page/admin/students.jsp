            ...
            <table>
                ...
                <c:forEach items="${userList}" var="student">
                    <tr>
                            ...
                            <div class="data">
                                <c:choose>
                                    <c:when test="${sessionScope.language eq 'EN'}">
                                        <fmt:formatDate pattern="MM-dd-yyyy" value="${student.birthDate}"/>
                                    </c:when>
                                    <c:when test="${sessionScope.language eq 'RU'}">
                                        <fmt:formatDate pattern="dd.MM.yyyy" value="${student.birthDate}"/>
                                    </c:when>
                                </c:choose>
                            </div>
                        </td>
                        ...
                        <td>
                            <button id="${student.id}" name="buttonStudent" value="${student.id}"
                                    data-username="${student.firstName} + ${student.lastName}"
                                    data-userrole="${student.role}"
                                    data-userblockingstatus="${student.blockingStatus}"
